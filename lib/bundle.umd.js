(function (global, factory) {
  ...
  function () {
    function ComponentContainer() {
      ...
      _defineProperty(this, "getComponent", function (name) {
      ...
      _defineProperty(this, "createDependencies", function () {
        return Object.keys(_this.registered).forEach(_this.createDependency);
      });

      _defineProperty(this, "createNodeDependencies", function (key) {
        _this.registered[key].dependencies.forEach(_this.createDependency);
      });

      _defineProperty(this, "createDependency", function (dep) {
      ...
      _defineProperty(this, "getDependenciesFromContainer", function (dependencies) {
        return dependencies.map(_this.getComponent);
      });

      _defineProperty(this, "isComponentCyclic", function (key) {
  ...
  _defineProperty(ComponentScan, "scan", function (paths) {
    paths.reduce(ComponentScan.getPaths, []).forEach(require);
  });

  _defineProperty(ComponentScan, "getPaths", function (acc, path) {
  ...
  var Inject = function Inject(name) {
    return function () {
      return {
